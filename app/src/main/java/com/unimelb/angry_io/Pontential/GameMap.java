package com.unimelb.angry_io.Pontential;
 ...
 * @version 1.0
 */
public class GameMap extends GameImage
{
	...
	public GameMap(Context context, Point point)
	{
		super(context);
	...
	public GameMap(Context context, int drawable, Point point)
	{
	...
	{
		return ((this.mType != GameMap.TYPE_EMPTY) && this.mVisible);
	}

	public boolean isBlockerTile()
	{
		if (this.mType == GameMap.TYPE_EMPTY)
		{
			return false;
		}
